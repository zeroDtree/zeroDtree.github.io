...
- Let $\mathscr{A}$ and $\mathscr{B}$ be wfs. of $L$. Say $\mathscr{A}$ and $\mathscr{B}$ are **provably equivalent** if $\vdash_{K}\mathscr{(A \iff B)}$.
...
8. For any wfs. $\mathscr{A} \text{ and } \mathscr{B} \text{ of } \mathscr{L}$, $\vdash_{K}\mathscr{(A \iff B)}$ iff $\vdash_{K}\mathscr{(A \to B)}$ and $\vdash_{K}\mathscr{(B \to A)}.$
...
10. If $x_i$ occur free in $\mathscr{A}(x_i)$ and $x_j$ is variable that not occur, free or bound, in $\mathscr{A}(x_i)$, then $\vdash_{K} (\forall x_i \mathscr{A}(x_i) \iff \forall x_j \mathscr{A}(x_j))$.
...
12. $\vdash_{K}A'\to A$
13. Let $\mathscr{A}$ and $\mathscr{B}$ be wfs. of $\mathscr{L}$, and suppose that $\mathscr{B}_0$ arises from the wf. $\mathscr{A}_0$ by substituting $\mathscr{B}$ for one or more occurrences of $\mathscr{A}$ in $\mathscr{A}_0$. Then $\vdash_{K}\bigl((\mathscr{A}\iff\mathscr{B})'\rightarrow(\mathscr{A}_0\iff\mathscr{B}_0)\bigr)$.
14. If $x_j$ does not appear (free or bound) in the wf. $\mathscr{A}(x_i)$, and the wf. $\mathscr{B}_0$ arises from $\mathscr{A}_0$ by replacing one or more occurrences of $(\forall x_i)\mathscr{A}(x_i)$ by occurrences of $(\forall x_j)\mathscr{A}(x_j)$, then $\vdash_{K} (\mathscr{A}_0\iff\mathscr{B}_0).$
